...
import { Trophy, Calendar, Share2, Check, Clock, Archive } from 'lucide-react';
...
export function Home() {
  ...
  const finishedMatches = matches.filter(m => m.status === 'finished').sort((a, b) => (b.startTime || 0) - (a.startTime || 0));
